...
<template>
  <div
    class="w-1/3 rounded-xl p-8 shadow flex flex-col justify-center items-center overflow-auto h-screen"
  >
    <div class="flex pt-[300px] flex-col gap-4 text-center items-center justify-center">
